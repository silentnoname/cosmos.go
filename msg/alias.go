...
type (
	...
	MigrateCode = wasmtypes.MsgMigrateContract
	...
	//
	ClearAdmin = wasmtypes.MsgClearAdmin

	//
	ClearAdminResponse = wasmtypes.MsgClearAdminResponse

	//
	Client = wasmtypes.MsgClient

	//
	ExecuteContractResponse = wasmtypes.MsgExecuteContractResponse

	//
	IBCCloseChannel = wasmtypes.MsgIBCCloseChannel

	//
	IBCSend = wasmtypes.MsgIBCSend

	//
	InstantiateContractResponse = wasmtypes.MsgInstantiateContractResponse

	//
	MigrateContractResponse = wasmtypes.MsgMigrateContractResponse

	//
	Server = wasmtypes.MsgServer

	//
	StoreCodeResponse = wasmtypes.MsgStoreCodeResponse

	//
	UpdateAdmin = wasmtypes.MsgUpdateAdmin

	//
	UpdateAdminResponse = wasmtypes.MsgUpdateAdminResponse
...
var (
	...
	NewCodeInfo           = wasmtypes.NewCodeInfo
	NewWasmCoins          = wasmtypes.NewWasmCoins
	NewEnv                = wasmtypes.NewEnv
	Newinfo               = wasmtypes.NewInfo
	NewAbsoluteTxPosition = wasmtypes.NewAbsoluteTxPosition
	NewContractInfo       = wasmtypes.NewContractInfo
	NewMsgClient          = wasmtypes.NewMsgClient
	NewQueryClient        = wasmtypes.NewQueryClient
)
